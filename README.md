...
CREATE TABLE `article_info`  (
  ...
  `abstract` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文章摘要',
  ...
  `reading` int(11) DEFAULT NULL COMMENT '文章阅读量',
  `love` int(11) DEFAULT NULL COMMENT '文章点赞数量',
  `discuss` int(11) DEFAULT NULL COMMENT '文章评论量',
  `status` tinyint(3) DEFAULT NULL COMMENT '文章状态(0 草稿、1已发布、2已删除)',
...
CREATE TABLE `category_info`  (
  `id` int(11) NOT NULL COMMENT '分类信息主键',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类名称',
  `describe` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分类描述',
...
CREATE TABLE `discuss_info`  (
  ...
  `system` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评论者操作系统',
