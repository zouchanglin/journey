            ...
            <form class="navbar-form navbar-left" role="search">
                <div class="form-group">
                    <label for="tittle"></label><input type="text" id="tittle" name="title" class="form-control" placeholder="博客标题(1-100)"
                                                       style="width: 700px" value="${article.articleInfo.tittle}"/><!-- 700px -->
                    <label for="id"></label><input id="id" type="text" style="display: none" value="${article.articleInfo.id}">
                </div>
            </form>
        </div>
    </div>
    <div style="width: 100%; height: 100%">
        <form name="mdEditorForm" style="padding-top: 0; height: 100%">
            <div id="test-editormd" style="width: 100%; height: 100%">
                <!-- 如果是修改的话 -->
                <label for="content"></label><textarea style="display:none;" name="content" id="content">${article.articleInfo.content}</textarea>
            </div>
        </form>
    </div>
</div>
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="form-control" placeholder="好的文章摘要易于检索...(摘要最多150字, 否则会保存失败)"
                                      id="summary" style="width: 95%;border-radius: 6px; padding: 10px; border-color: #EEEEEE; height: 150px"
                            >${article.articleInfo.summary}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="margin: 0">
                            ...
                            <select id="category" name="" style="width: 40%; height: 40px;">
                                ...
                                　　<option value="${cate.id}"
                                          <#if article.articleInfo.category == cate.id>
                                              selected="selected"
                                          </#if>
                                          style="border-radius: initial">${cate.myname}
                                    </option>
                                </#list>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="margin: 0" id="selectedTag">
                            <!-- 先打上Id标记此标签 -->
                            <#list checkedTag as onetag>
                            <button id="${onetag.id}"
                                    value="${onetag.id}"
                                    type="button"  style="margin-top: 8px;
                                    margin-left: 8px" class="btn btn-default"
                                    onclick="uncheckedTag(this)">${onetag.name}</button>
                            </#list>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea name="form-control" placeholder="好的文章摘要易于检索...(摘要最多150字, 否则会保存失败)"
                                                                    id="summary2" style="width: 95%;border-radius: 6px; padding: 10px; border-color: #EEEEEE; height: 150px">${article.articleInfo.summary}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">选择分类</label>
                        <div class="col-sm-10" style="margin: 0">
                            ...
                            <select id="category2" name="" style="width: 40%; height: 40px;">
                                ...
                                　　<option value="${cate.id}"
                                        <#if article.articleInfo.category == cate.id>
                                            selected="selected"
                                        </#if>style="border-radius: initial">${cate.myname}</option>
                                </#list>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="margin: 0" id="selectedTag2">
                            ...
                            <#list checkedTag as onetag>
                            <button id="${onetag.id}"
                                    value="${onetag.id}" type="button"  style="margin-top: 8px; margin-left: 8px" class="btn btn-default"
                                    onclick="uncheckedTag2(this)">${onetag.name}</button>
                            </#list>
                        </div>
                    </div>
                    <div class="form-group">
